        ...
        <form @submit.prevent="updateRole" >
            ...
            <table class="table table-sm">
                ...
                <tbody >
                    ...
                    <tr v-if="tab==1">
                        <td>Installment</td>
                        <td ><c-switch  class="mx-1" color="info" label outline="alt" variant="pill" v-model="rolePermission.installment_view"  /></td>
                        <td ><c-switch  class="mx-1" color="info" label outline="alt" variant="pill" v-model="rolePermission.installment_view_all"  /></td>
                        <td><c-switch class="mx-1" color="info"  label outline="alt" variant="pill"  v-model="rolePermission.installment_create"  /></td>
                        <td><c-switch class="mx-1" color="info"  label outline="alt" variant="pill"  v-model="rolePermission.installment_update" /></td>
                        <td><c-switch class="mx-1" color="info"  label outline="alt" variant="pill"  v-model="rolePermission.installment_update_all" /></td>
                        <td><c-switch class="mx-1" color="info"  label outline="alt" variant="pill"  v-model="rolePermission.installment_delete"  /></td>
                        <td><c-switch class="mx-1" color="info"  label outline="alt" variant="pill"  v-model="rolePermission.installment_delete_all"  /></td>
                    </tr>
                    <tr v-if="tab==1">
                        <td>User Role</td>
    ...
    data(){
        return{
            ...
            rolePermission:{
                ...
                installment_view:false,
                installment_view_all:false,
                installment_create:false,
                installment_update:false,
                installment_update_all:false,
                installment_delete:false,
                installment_delete_all:false,
    ...
    methods:{
        ...
        openModal(user_role,index){
            console.log(user_role)
                ...
                this.rolePermission.installment_view = user_role.permission.installment_view
                this.rolePermission.installment_view_all = user_role.permission.installment_viewall
                this.rolePermission.installment_create = user_role.permission.installment_create
                this.rolePermission.installment_update = user_role.permission.installment_update
                this.rolePermission.installment_update_all = user_role.permission.installment_updateall
                this.rolePermission.installment_delete = user_role.permission.installment_delete
                this.rolePermission.installment_delete_all = user_role.permission.installment_deleteall
