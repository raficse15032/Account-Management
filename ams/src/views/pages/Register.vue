            ...
            <b-card-body class="p-4">
              <b-form @submit.prevent="Register">
                ...
                <b-input-group class="mb-3">
                  ...
                  <b-form-input v-validate="'required|min:3|max:20'" data-vv-as="name" name="name_field"  v-model="register.name" type="text" class="form-control" placeholder="Username" autocomplete="username" />
                </b-input-group>
