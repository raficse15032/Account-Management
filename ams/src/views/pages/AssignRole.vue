<template>
    <div class="card">
        <div class="container-fluid">
            <button v-if="permission.contact_create"  type="button" @click="openModal" class="btn btn-primary contct-b pull-left"><i class="icons icon-user-follow"></i> Add Employee</button>
