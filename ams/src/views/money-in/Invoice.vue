    ...
    <div class="card">
        <div class="container-fluid">
            ...
            <nav aria-label="Page navigation example">
                <pagination :data="Object.assign({},invoices2)" @pagination-change-page="getResults"></pagination>
            </nav>
        </div>
...
import { ALL_PURPOSE,DELETE_INVOICE,ALL_USER_ROLE2,SEARCH_INVOICE,ALL_INVOICE } from '../../store/action.type';
export default {
    data(){
        return {
            loading:false,
    ...
    computed: {
        ...mapGetters(["getAccountType","invoices","invoices2","purposes","allContacts"]),
    },
    components: {
        InvoiceAddModal,
        InvoiceEditModal,
