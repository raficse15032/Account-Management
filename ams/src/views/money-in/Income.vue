            ...
            <table class="table table-sm">
                ...
                <tbody>
                    <tr v-for="(income,index) in incomes" :key="index">
                        ...
                        <td>{{income.agent}}</td>
                        <td>{{((parseFloat(income.amount)+parseFloat(income.utility)+parseFloat(income.car_parking)+parseFloat(income.registration_cost)+parseFloat(income.other_cost))-(parseFloat(income.discount)+parseFloat(income.gift)))}}</td>
                        <td>
