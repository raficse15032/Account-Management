            ...
            <div>
                ...
                <thead>
                    <tr>
                       ...
                       <!--  <th scope="col">Payment Adjustment</th> -->
                ...
                <tbody>
                    <tr v-for="(invoice,index) in list.invoices" :key="index">
                       ...
                       <!--  <td><input type="number"  v-model="invoice.adjustment" class="form-control"></td> -->
                        ...
                        <!-- @change="amountf(index,invoice.amount)" -->
                    </tr>
                </tbody>
            </table>
                <div class="form-group row">
...
export default {
    ...
    methods:{
        openModal(payment,index){
            ...
            this.list.payment_mode_id = payment.payment_mode_id
        ...
        amountf(amount){
            ...
            this.list.invoices.forEach(invoice=>{
                if(temp_amount<=invoice.due_amount){
                    invoice.amount = temp_amount;
                    temp_amount = 0;
                }else{
                    invoice.amount = invoice.due_amount;
                    let temamount = temp_amount-invoice.due_amount;
                    if(temamount<0){
                        temp_amount = 0;
                    }else{
