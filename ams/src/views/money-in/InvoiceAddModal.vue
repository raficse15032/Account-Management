            ...
            <div>
                <div class="form-group row">
                    ...
                    <div v-if="newInvoice.mode == 3" class="col-sm-4">
                        <input :value="newInvoice.per_installment_amount.toFixed(2)" disabled style="background-color:#DBEEED" class="form-control" type="text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            ...
                            <!-- <span  v-if="customervisas.length <= 0" style="background: #e0ebeb;padding-left:10px;padding-right:10px;" class="input-group-addon">
                ...
                <div  v-if="invoice_type==1" class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select v-validate="'required'" name="Purpose" v-model="newInvoice.account_id"  class="form-control" >
