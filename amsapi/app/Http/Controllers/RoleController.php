    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $role->permissions = [
                ...
                'installment.view'   => $request->installment_view,
                'installment.viewall'   => $request->installment_view_all,
                'installment.create' => $request->installment_create,
                'installment.update' => $request->installment_update,
                'installment.updateall' => $request->installment_update_all,
                'installment.delete' => $request->installment_delete,
                'installment.deleteall' => $request->installment_delete_all,
            ...
            $role->permissions2 = json_encode([
                ...
                'installment_view'   => $request->installment_view,
                'installment_viewall'   => $request->installment_view_all,
                'installment_create' => $request->installment_create,
                'installment_update' => $request->installment_update,
                'installment_updateall' => $request->installment_update_all,
                'installment_delete' => $request->installment_delete,
                'installment_deleteall' => $request->installment_delete_all,
